...
const videos = ["", "https://www.youtube.com/embed/PXxeydkPS9I?si=tLlxbi1nonpMYui", "https://www.youtube.com/embed/sMj9-qR-aKI?si=xQ2Eivz8e_qV3_iR",
  ...
  "https://www.youtube.com/embed/znkIJoZRnDc?si=QvQoOiZ1u6mBzWab", "https://www.youtube.com/embed/aAESVCogiAU?si=8k6fIpWjodEYfPcW",
  "https://www.youtube.com/embed/C4n_9ZL4DpE?si=IixRZ4sEVsXZSZo0"
]
...
const imagenes = ["", "safe_and_sound.png", "fix_you.png", "sunday_morning.jpg", "linger.png", "duvet.png", "dango_daikazoku.png", "they_long_to_be.png",
  ...
  "dream_a_little_dream_of_me.png", "my_way.png", "ruler_of_everything.png", "alone_again.png", "starman.png", "honey_bee.png", "time_to_pretend.png"];
  ...
  "stereo_hearts_og.jpg", "your_graduation_og.jpg", "telephone_number_og.jpg", "california_girls_og.png", "dancing_queen_og.jpg", "lovefool_og.jpg","beyond_the_sea_og.jpg", 
  "dream_a_little_dream_of_me_og.jpg", "my_way_og.jpg", "ruler_of_everything_og.jpg", "alone_again_og.jpg", "starman_og.png", "honey_bee_og.jpg", "time_to_pretend_og.jpg"];
...
const artistas = ["", "NameLater", "NameLater", "Sahelanthropus", "Ryoshi", "Gestalt", "NameLater", "Ryoshi",
  ...
  "NameLater", "NameLater", "Gestalt", "NameLater", "Gestalt", "NameLater", "NameLater"];
...
const songTitles = ["", "Safe and Sound", "Fix You", "Sunday Morning", "Linger", "Duvet", "Dango Daikazoku", "(They Long to Be) Close to You",
  ...
  "Dream A Little Dream Of Me", "My Way", "Ruler Of Everything", "Alone Again (Naturally)", "Starman", "Honeybee", "Time To Pretend"];
...
const originalSongArtists = ["", "Capital Cities", "Coldplay", "Maroon5", "The Cranberries", "Bôa", "Chata", "The Carpenters",
  ...
  "Ella Fitzgerald", "Frank Sinatra", "Tally Hall", "Gilbert O'Sullivan", "David Bowie", "Steam Powered Giraffe", "MGMT"];
...
const albumNames = ["", "In a Tidal Wave of Mystery", "X&Y", "Songs About Jane", "Everybody Else Is Doing It, So Why Can't We?", "Twilight", "Dango Daikazoku", "Close to You",
  ...
  "Dream A Little Dream Of Me, Vol. 1", "My Way", "Marvin's Marvelous Mechanical Museum", "Himself", "The Rise and Fall of Ziggy Stardust and the Spiders from Mars", "The 2¢ Show", "Oracular Spectacular"];
...
function createCarouselItems() {
  ...
  slideData.forEach(item => {
    ...
    if (item.imageOgUrl == "credits_art.png") {
      ...
      titulo.textContent = 'DISPOKOGRAPHY CREDITS'

      const textThanks = document.createElement('div');
      textThanks.textContent = 'THANKS TO EVERYONE WHO MADE ALL OF THIS POSSIBLE!';

      const artistsList = document.createElement('div');
      artistsList.innerHTML = '</br><b>Artists:</b></br>' +  
                              '<ul>' +
                              '<li>Ryoshi</li>' + 
                              '<li>Sigma of Gestalt</li>' + 
                              '<li>I Will Think About My Name Later</li>' + 
                              '<li>Sahelanthropus</li>' + 
                              '<li>Arteries</li>';
    const recopilationList = document.createElement('div');
    recopilationList.innerHTML = '</br><b>Recopilation of songs and video editing:</b></br>' +  
                            '<ul>' +
                            '<li>Cherro</li>';
    const webdevList = document.createElement('div');
    webdevList.innerHTML = '</br><b>Organization and Web Development:</b></br>' +  
                            '<ul>' +
                            '<li>Dani</li></br>' + 
                            'Also thanks to all the fandits for submitting what songs they would like to see on here!<br/><br/>' +
                            '<b><a style="color:#FFFFFF" href="https://www.youtube.com/watch?v=1NUtPXgYZdU&list=PLUbwTVu_NL7hUr17FgSdjq65u4gZQ928y&index=1">Link to the playlist with all the songs:</a></b>';


      /*const participantsList = document.createElement('ul');

      const artistas = document.createElement('li');
      artistas.textContent = ": Ryoshi, Sigma Of Gestalt, I Will Think About My Name Later, Sahelanthropus, Arteries";
      ...
      textCreditos.appendChild(textThanks);
      textCreditos.appendChild(artistsList);
      textCreditos.appendChild(recopilationList);
      textCreditos.appendChild(webdevList);
